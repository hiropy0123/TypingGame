...
Typing.datas = [
    ...
    {
        question: "こここそ神の家にほかならない。ここは天の門だ",
        kana: "コココソカミノイエニホカナラナイ。ココハテンノモンダ",
        comment: "創世記28:17"
    },
    {
    ...
    {
        question: "イスラエルはわたしの子、わたしの初子である",
        kana: "イスラエルハワタシノコ、ワタシノウイゴデアル",
        comment: "出エジプト記4:22"
    },
    {
        question: "あなたには、わたしのほかに、ほかの神々があってはならない",
        kana: "アナタニハ、ワタシノホカニ、ホカノカミガミガアッテハナラナイ",
        comment: "出エジプト記20:3"
    },
    {
        question: "あなたがたの神、主であるわたしが聖であるから、あなたがたも聖なる者とならなければならない",
        kana: "アナタガタノカミ、シュデアルワタシガセイデアルカラ、アナタガタモセイナルモノトナラナケレバナラナイ",
        comment: "レビ19:2"
    },
    {
        question: "主があなたを祝福し、あなたを守られますように",
        kana: "シュガアナタヲシュクフクシ、アナタヲマモラレマスヨウニ",
        comment: "民数記6:24"
    },
    {
        question: "心を尽くし、精神を尽くし、力を尽くして、あなたの神、主を愛しなさい",
        kana: "ココロヲツクシ、セイシンヲツクシ、チカラヲツクシテ、アナタノカミ、シュヲアイシナサイ",
        comment: "申命記6:5"
    },
    {
        question: "私と私の家とは主に仕える",
        kana: "ワタシトワタシノイエトハシュニツカエル",
        comment: "ヨシュア記24:15"
    },
    {
    ...
    {
        question: "立って朝ごとに主をほめたたえ賛美し、夕べにもそのようにせよ",
        kana: "タッテアサゴトニシュヲホメタタエサンビシ、ユウベニモソノヨウニセヨ",
        comment: "1歴代誌23:30"
    },
    {
        question: "主はあまねく全地を見渡し、その心がご自分と全く一つになっている人々に御力を現されます",
        kana: "シュハアマネクゼンチヲミワタシ、ソノココロガゴジブントマッタクヒトツニナッテイルヒトビトニミチカラヲアラワサレマス",
        comment: "2歴代誌16:9"
    },
    {
    ...
    {
        question: "力の限り、見張って、あなたの心を見守れ。いのちの泉はこれからわく",
        kana: "チカラノカギリ、ミハッテ、アナタノココロヲミマモレ。イノチノイズミハコレカラワク",
        comment: "箴言4:23"
    },
    {
        question: "いのちに至る叱責を聞く耳のある者は、知恵のある者の間に宿る",
        kana: "イノチニイタルシッセキヲキクミミノアルモノハ、チエノアルモノノアイダニヤドル",
        comment: "箴言15:31"
    },
    {
        question: "耳をそむけて教えを聞かない者は、その者の祈りさえ忌み嫌われる",
        kana: "ミミヲソムケテオシエヲキカナイモノハ、ソノモノノイノリサエイミキラワレル",
        comment: "箴言28:9"
    },
    {
        question: "幻がなければ、民はほしいままにふるまう。しかし律法を守るものは幸いである",
        kana: "マボロシガナケレバ、タミハホシイママニフルマウ。シカシリッポウヲマモルモノハサイワイデアル",
        comment: "箴言29:18"
    },
    {
        question: "神のなさることは、すべて時にかなって美しい",
        kana: "カミノナサルコトハ、スベテトキニカナッテウツクシイ",
        comment: "伝道者の書3:11"
    },
    {
        question: "あなたの若い日にあなたの創造者を覚えよ。",
        kana: "アナタノワカイヒニアナタノソウゾウシャヲオボエヨ",
        comment: "伝道者の書12:1"
    },
    {
        question: "主の道を整えよ。荒れ地で私たちの神のために大路を平らにせよ",
        kana: "シュノミチヲトトノエヨ。アレチデワタシタチノカミノタメニオオジヲタイラニセヨ",
        comment: "イザヤ40:3"
    },
    {
    ...
    {
        question: "わたしは初めであり、わたしは終わりである。わたしのほかに神はない",
        kana: "ワタシハハジメデアリ、ワタシハオワリデアル。ワタシノホカニカミハナイ",
        comment: "イザヤ44:6"
    },
    {
        question: "耕地を開拓せよ。いばらの中に種をまくな",
        kana: "コウチヲカイタクセヨ。イバラノナカニタネヲマクナ",
        comment: "エレミヤ4:3"
    },
    {
        question: "主のために割礼を受け、心の包皮を取り除け",
        kana: "シュノタメニカツレイヲウケ、ココロノホウヒヲトリノゾケ",
        comment: "エレミヤ4:4"
    },
    {
        question: "人の心は何よりも陰険でそれは直らない",
        kana: "ヒトノココロハナニヨリモインケンデソレハナオラナイ",
        comment: "エレミヤ17:9"
    },
    {
    ...
    {
        question: "権力によらず、能力によらず、わたしの霊によって",
        kana: "ケンリョクニヨラズ、ノウリョクニヨラズ、ワタシノレイニヨッテ",
        comment: "ゼカリヤ4:6"
    },
    {
        question: "後の雨のときに、主を呼び求めよ。主はいなびかりを造り、大雨を人々に与え、野の草をすべての人にくださる",
        kana: "ノチノアメノトキニ、シュヲヨビモトメヨ。シュハイナビカリヲツクリ、オオアメヲヒトビトニアタエ、ノノクサヲスベテノヒトニクダサル",
        comment: "ゼカリヤ10:1"
    },
    {
        question: "その日、主の足は、エルサレムの東に面するオリーブ山の上に立つ",
        kana: "ソノヒ、シュノアシハ、エルサレムノヒガシニメンスルオリーブヤマノウエニタツ",
        comment: "ゼカリヤ14:4"
    },
    {
        question: "心の貧しい者は幸いです。天の御国はその人たちのものだから",
        kana: "ココロノマズシイモノハサイワイデス。テンノミクニハソノヒトタチノモノダカラ",
        comment: "マタイ5:3"
    },
    {
    ...
    {
        question: "あなたは生ける神の御子キリストです",
        kana: "アナタハイケルカミノミコキリストデス",
        comment: "マタイ16:16"
    },
    {
    ...
    {
        question: "自分の十字架を負ってわたしについて来ない者は、わたしの弟子になることはできません",
        kana: "ジブンノジュウジカヲオッテワタシニツイテコナイモノハ、ワタシノデシニナルコトハデキマセン",
        comment: "ルカ14:27"
    },
    {
        question: "ふたりの主人に仕えることはできません",
        kana: "フタリノシュジンニツカエルコトハデキマセン",
        comment: "ルカ16:13"
    },
    {
        question: "人の子は、失われた人を捜して救うために来たのです",
        kana: "ヒトノコハ、ウシナワレタヒトヲサガシテスクウタメニキタノデス",
        comment: "ルカ19:10"
    },
    {
        question: "祝福あれ。主の御名によって来られる王に。天には平和、栄光はいと高き所に",
        kana: "シュクフクアレ。シュノミナニヨッテコラレルオウニ。テンニハヘイワ、エイコウハイトタカキトコロニ",
        comment: "ルカ19:38"
    },
    {
        question: "神は実にそのひとり子をお与えになったほどに世を愛された",
        kana: "カミハジツニソノヒトリゴヲオアタエニナッタホドニヨヲアイサレタ",
        comment: "ヨハネ3:16"
    },
    {
        question: "神は霊ですから、神を礼拝する者は、霊とまこととをもって礼拝しなければなりません",
        kana: "カミハレイデスカラ、カミヲレイハイスルモノハ、レイトマコトトヲモッテレイハイシナケレバナリマセン",
        comment: "ヨハネ4:24"
    },
    {
    ...
    {
        question: "わたしは帰ってきて、倒れたダビデの幕屋を立て直す",
        kana: "ワタシハカエッテキテ、タオレタダビデノマクヤヲタテナオス",
        comment: "使徒の働き15:16"
    },
    {
        question: "主イエスを信じなさい。そうすれば、あなたもあなたの家族も救われます",
        kana: "シュイエスヲシンジナサイ。ソウスレバ、アナタモアナタノカゾクモスクワレマス",
        comment: "使徒の働き16:31"
    },
    {
        question: "キリスト・イエスにある者が罪に定められることは決してありません",
        kana: "キリスト・イエスニアルモノガツミニサダメラレルコトハケッシテアリマセン",
        comment: "ローマ人への手紙8:1"
    },
    {
        question: "信仰は聞くことから始まり、聞くことはキリストについてのみことばによるのです",
        kana: "シンコウハキクコトカラハジマリ、キクコトハキリストニツイテノミコトバニヨルノデス",
        comment: "ローマ10:17"
    },
    {
        question: "この世と調子を合わせてはいけません。",
        kana: "コノヨトチョウシヲアワセテハイケマセン",
        comment: "ローマ12:2"
    },
    {
    ...
    {
        question: "大事なのは新しい創造です",
        kana: "ダイジナノハアタラシイソウゾウデス",
        comment: "ガラテヤ6:15"
    },
    {
        question: "聖霊は私たちが御国を受け継ぐことの保証です",
        kana: "セイレイハワタシタチガミクニヲウケツグコトノホショウデス",
        comment: "エペソ1:14"
    },
    {
        question: "いつも喜んでいなさい。絶えず祈りなさい。すべてのことについて感謝しなさい",
        kana: "イツモヨロコンデイナサイ。タエズイノリナサイ。スベテノコトニツイテカンシャシナサイ",
        comment: "1テサロニケ5:16-18"
    },
    {
        question: "神は、すべての人が救われて真理を知るようになるのを望んでおられます",
        kana: "カミハ、スベテノヒトガスクワレテシンリヲシルヨウニナルノヲノゾンデオラレマス",
        comment: "1テモテ2:4"
    },
    {
        question: "信仰の戦いを勇敢に戦い、永遠のいのちを獲得しなさい。",
        kana: "シンコウノタタカイヲユウカンニタタカイ、エイエンノイノチヲカクトクシナサイ",
        comment: "1テモテ6:12"
    },
    {
        question: "確かに、キリスト・イエスにあって敬虔に生きようと願うものはみな、迫害を受けます",
        kana: "タシカニ、キリスト・イエスニアッテケイケンニイキヨウトネガウモノハミナ、ハクガイヲウケマス",
        comment: "2テモテ3:12"
    },
    {
        question: "聖書はすべて、神の霊感によるもので、教えと戒めと矯正と義の訓練のために有益です",
        kana: "セイショハスベテ、カミノレイカンニヨルモノデ、オシエトイマシメトキョウセイトギノクンレンノタメニユウエキデス",
        comment: "2テモテ3:16"
    },
    {
        question: "信仰がなくては、神に喜ばれることはできません",
        kana: "シンコウガナクテハ、カミニヨロコバレルコトハデキマセン",
        comment: "ヘブル11:6"
    },
    {
        question: "信仰の創始者であり、完成者であるイエスから目を離さないでいなさい",
        kana: "シンコウノソウシシャデアリ、カンセイシャデアルイエスカラメヲハナサナイデイナサイ",
        comment: "ヘブル12:2"
    },
    {
        question: "万物の終わりが近づきました。ですから、祈りのために、心を整え身を慎みなさい",
        kana: "バンブツノオワリガチカヅキマシタ。デスカラ、イノリノタメニ、ココロヲトトノエミヲツツシミナサイ",
        comment: "1ペテロ4:7"
    },
    {
    ...
    {
        question: "愛には恐れがありません。まったき愛は恐れを締め出します",
        kana: "アイニハオソレガアリマセン。マッタキアイハオソレヲシメダシマス",
        comment: "1ヨハネ4:18"
    },
    {
